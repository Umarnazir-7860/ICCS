...
const CoreValuesSection = () => {
  ...
  return (
    <section className="bg-gray-50">
      ...
      className="max-w-7xl flex flex-col mx-auto mt-5 px-4 py-10 md:px-8 text-left md:text-center mb-5">
        <motion.h2
        ...
        <motion.p
          ...
          className="mt-1 text-gray-700 max-w-2xl mx-auto"
        >
      ...
      <div className="max-w-7xl mx-auto mt-8 px-4 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
